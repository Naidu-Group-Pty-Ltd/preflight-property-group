/**
 * Command Centre staff login — the current entrypoint.
 *
 * The handler is `_shared/customAuth/login.ts`, shared with the other entrypoint
...
Deno.serve((req: Request) => handleStaffLogin(req, 'v2'));
