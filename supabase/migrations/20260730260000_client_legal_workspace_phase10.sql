-- Phase 10: governed Client Portal legal workspace projection and acknowledgements.
-- Additive only. Operational legal tables remain private and service-role mediated.
...
-- Deterministic projection backfill. Only explicitly linked matters contribute.
