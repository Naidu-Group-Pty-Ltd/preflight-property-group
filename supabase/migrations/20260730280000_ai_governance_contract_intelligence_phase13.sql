-- Phase 13: governed, traceable and review-gated legal AI.
...
-- Explicit service mediation: no browser/PostgREST access.
...
DO $$ DECLARE t text; BEGIN FOREACH t IN ARRAY ARRAY['firm_ai_policies','ai_prompt_versions','ai_analysis_runs','ai_analysis_sources','ai_analysis_reviews'] LOOP EXECUTE format('ALTER TABLE public.%I ENABLE ROW LEVEL SECURITY',t); EXECUTE format('CREATE POLICY %I ON public.%I FOR ALL TO service_role USING(true) WITH CHECK(true)',t||'_service',t); END LOOP; END $$;
