-- @effect: select 1 from public.template_master_refresh_decisions where release = '20261219060000_seed_template_library_v20_continuous_front_matter'
...
with adopted as (
  ...
  left join public.template_library_release_baselines b
    on b.entry_id = e.id
   and b.release = '20261219060000_seed_template_library_v20_continuous_front_matter'
  where t.is_active
...
set
  ...
  config = jsonb_set(
    ...
    to_jsonb('20261219060000_seed_template_library_v20_continuous_front_matter'::text)
  ),
  updated_at = now()
from _v20_classified c
...
--   where release = '20261219060000_seed_template_library_v20_continuous_front_matter'
...
--     and s.migration = '20261219070000_refresh_active_masters_from_library_v20'
