/**
 * Empty states for the Solicitor Portal — mirrors `FinanceEmptyState` (and the
 * client portal's `PortalEmptyState`) so a dead end always offers a next step.
 */
...
interface SolicitorEmptyStateProps {
  icon: ReactNode;
  title: string;
  description: string;
  actionLabel?: string;
...
export function SolicitorEmptyState({
  icon,
  title,
  description,
  actionLabel,
