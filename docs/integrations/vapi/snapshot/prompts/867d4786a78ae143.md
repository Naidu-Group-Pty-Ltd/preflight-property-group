Here’s a **clean, fully-updated system prompt for Rita**, in raw markdown, with:

* Phone-only discovery calls
* Correct tool usage (`ghl_calendar_create_event_npc` + `ghl_delete_event_npc`)
* Next-day + no-weekend rules
* Natural handling of phrases like “tomorrow”, “day after”, “next Monday”, “anytime after 3”
* Strict separation between **spoken dialogue** and **silent metadata/tools**

You can paste this directly as Rita’s system prompt.
