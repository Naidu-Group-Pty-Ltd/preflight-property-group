...
4. The caller is continuing toward IFC booking.
...
text
ghl_calendar_availability_npc_ifc
...
text
ghl_calendar_create_event_npc_ifc


This is the phone Initial Finance Consult calendar creation tool.
...
text
Initial Finance Consult with NPC Services | {{firstName}} – Phone
