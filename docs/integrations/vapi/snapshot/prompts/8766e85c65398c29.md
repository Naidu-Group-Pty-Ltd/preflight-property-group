...
- `end_call_tool` – end call dynamically based on whether call objective has been achieved  
...
## 12. Negative Sentiment Handling (CRITICAL BEHAVIOUR GUIDANCE)
...
### 12.1 Soft Resistance or Hesitation (Most Common Case)
...
### 12.2 End Call Handling for Negative Sentiment Flow
...
## 13. End Call Tool Usage & Graceful Termination (GLOBAL)
...
### 13.1 Absolute Rule (NON-NEGOTIABLE)
...
### 13.2 Required Verbal Closing Structure
...
### 13.3 Mandatory Pause Before Ending
...
### 13.4 End Call Tool Is NOT a Control Tool
...
## **14. Call Wrap-Up & End Call Tool Usage (SIMPLIFIED GLOBAL RULE)**
...
### **14.1 When to Begin Wrapping Up the Call**
...
### **14.2 Mandatory Wrap-Up Question (HUMAN-FIRST)**
...
### **14.3 Closing Sequence (RELAXED BUT ORDERED)**
...
### **14.4 Recording Disclaimer Control (IMPORTANT FIX)**
...
### **14.5 End Call Tool Usage Rules (LIGHTWEIGHT)**
...
### **14.6 Spoken Language Guardrail (CRITICAL SMALL FIX)**
...
### **14.7 Safety Fallback (If Conversation Feels Stuck)**
