...
`4274ab0d-f8e6-4ab9-9b47-1f12255e73c0` · org `c9015cd5-3701-4ac5-aa9c-be6cdcaaecdd` · created 2025-12-08 · updated 2026-07-22 05:54:02 · version `v1`
...
- **voicemailMessage**: 
  ...
  > Hi, this is Tina from Naidu Property Consulting Services; we weren’t able to reach you for your initial finance consult earlier. If you'd like to book a new slot, feel free to call us back on this number and we'll find one that works for you.
...
- `system` — 41,404 chars → [`prompts/a240f7fbce7a468d.md`](../prompts/a240f7fbce7a468d.md)

## Call history (counts only — no call content captured)

- **calls returned** (window of 100): 3
